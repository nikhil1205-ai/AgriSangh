import { Home, Users, MessageCircle, Sprout, BarChart3, Box, DollarSign, Droplet, Cpu, Activity, Settings, LogOut } from "lucide-react";
          ...
          {filteredMenu.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-3xl px-4 py-3 text-left text-sm font-semibold transition ${active ? "bg-emerald-500 text-white shadow-xl shadow-emerald-500/20" : "text-slate-300 hover:bg-slate-900/80 hover:text-white"}`}
              >
                <Icon size={18} />
                {item.label}
              </button>
